...
Nas seguintes ilustrações serão descritas duas situações de jogos fundamentais. Nesta primeira situação o jogo está a começar e o jogador vai distribuir a segunda cavidade de sementes. Assim, as sementes ficaram distribuídas
\begin{figure} [H]
        \centering
...
A outra jogada importante é a de captura de sementes.
